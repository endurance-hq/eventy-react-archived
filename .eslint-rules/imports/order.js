const { buildPathGroupsBasedOnEsbuildAliases } = require(__dirname +
  "/../helpers");

const pathGroups = buildPathGroupsBasedOnEsbuildAliases({});
...
module.exports = {
  rules: {
    // auto-fixable: Enforce a convention in module import order - we enforce
    "import/order": [
      "error",
      {
